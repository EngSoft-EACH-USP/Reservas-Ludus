...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { data: @reserva.data, email: @reserva.email, hora: @reserva.hora, nome: @reserva.nome, obs: @reserva.obs, pessoas: @reserva.pessoas, pne: @reserva.pne, telefone: @reserva.telefone } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { data: @reserva.data, email: @reserva.email, hora: @reserva.hora, nome: @reserva.nome, obs: @reserva.obs, pessoas: @reserva.pessoas, pne: @reserva.pne, telefone: @reserva.telefone } }
